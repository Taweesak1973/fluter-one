...
class PresentScreenPage extends StatefulWidget {
  const PresentScreenPage({super.key});

  @override
  State<PresentScreenPage> createState() => _PresentScreenPageState();
}

class _PresentScreenPageState extends State<PresentScreenPage> {
  ...
  Map<String, dynamic> mainQuestion = {
    'Simple Tense': ['S', 'V.1(s,es)'],
    'Continuous Tense': ['S', 'is,am,are', 'V.1 ing'],
    'Perfect Tense': ['S', 'has,have', 'V.3'],
    'Perfect Continuous Tense': ['S', 'has,have', 'been', 'V.1 ing'],
  };
        ...
        body: Center(
          child: ListView(
            children: [
              ...
              Container(
                  width: maxWidth, height: maxheight * .3, child: ButtonSheet())
              //question
            ],
          ),
        ),
  ...
  void fun() {
    ...
    setState(() {
      ...
      if (nameHead == 'Simple Tense') {
        String quest = selectQuestionWord('Simple');
        questionWord = quest;

        namesub1 = questionWord == 'S' ? questMark : mainQuestion[nameHead][0];

        namesub2 =
            questionWord == 'V.1(s,es)' ? questMark : mainQuestion[nameHead][1];
        namesub3 = '';
        namesub4 = '';
        plus2 = const Text('');
        plus3 = const Text('');
        ...
        String quest = selectQuestionWord('Continuous');
        questionWord = quest;
        namesub1 = questionWord == 'S' ? questMark : mainQuestion[nameHead][0];
        namesub2 =
            questionWord == 'is,am,are' ? questMark : mainQuestion[nameHead][1];
        namesub3 =
        ...
        String quest = selectQuestionWord('Perfect');
        questionWord = quest;
        namesub1 = questionWord == 'S' ? questMark : mainQuestion[nameHead][0];
        namesub2 =
            questionWord == 'has,have' ? questMark : mainQuestion[nameHead][1];
        namesub3 =
        ...
        String quest = selectQuestionWord('Perfect Continuous');
        questionWord = quest;
        ...
        specialWidth1 = maxWidth * .16;
        specialWidth2 = maxWidth * .16;
      }
